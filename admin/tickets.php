                            ...
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;" id="licenses">
                                    ...
                                    if ($user->hasPermission() === true) {
                                        ...
                                        ');
                                        $mysql->bindValue(1, "Open", PDO::PARAM_STR);
                                        $mysql->execute();
                                        ...
                                        while ($data = $mysql->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $ID = $data['ID'];
                                            $action = '<button type="button" class="btn btn-danger col-lg-12" id="read" data-id="' . $data['ID'] . '">Read</button>';

                                            echo "<tr><td>{$ID}</td><td>{$name}</td><td>{$title}</td><td>{$priority}</td><td>{$action}</td></tr>";
                                        }
                                    }
