                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="login_data" class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;">
                                    <thead>
                                    <tr>
                                        <td>Username</td>
                                        <td>Action</td>
                                    ...
                                    if ($user->hasPermission() === true) {
                                        ...
                                        while ($data = $mysql->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<tr><td>{$username}</td><td>{$action}</td><td>{$ip}</td></tr>";
                                        }
                                    }
                                    ?>
                                    </tbody>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table class="table table-striped table-bordered dt-responsive nowrap" style="width:100%;" id="global_logs">
                                    <thead>
                                        <tr>
                                            <td>Username</td>
                                            <td>Email</td>
                                    ...
                                    if ($user->hasPermission() === true) {
                                        ...
                                        while ($data = $mysql->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            $email = $data['email'];
                                            $rank = $data['rank'];
                                            $action = "<button class='btn btn-success col-lg-12' id='edit' data-id='{$data['username']}'>Edit user</button>";
                                            $plan = $data['plan'];
                                            ...
                                            echo "<tr><td>{$username}</td><td>{$email}</td><td>{$plan}</td><td>{$status}</td><td>{$action}</td></tr>";
                                        }
                                    }
                                    ?>
                                    </tbody>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <table id="global_attacks" class="table table-striped table-bordered dt-responsive nowrap">
                                    <thead>
                                        <tr>
                                            <td>User</td>
                                            <td>Target</td>
                                    ...
                                    if ($user->hasPermission() === true) {
                                        ...
                                        while ($data = $mysql->fetch(PDO::FETCH_ASSOC)) {
                                            ...
                                            echo "<tr><td>{$username}</td><td>{$target}</td><td>{$port}</td><td>{$time}</td><td>{$version}</td></tr>";
                                        }
                                    }
                                    ?>
...
<script>
    $(document).on('click', '#edit', function () {
        var id = $(this).data('id');
        window.location = "edit_user?username="+id
    })
</script>
