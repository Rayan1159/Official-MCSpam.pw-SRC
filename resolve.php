        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="page-title-box">
                    ...
                    <h4 class="page-title mb-2"><i class="mdi mdi-monitor-dashboard mr-2"></i>Resolver</h4>
                    <div class="">
                        <ol class="breadcrumb">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <input type="text" id="host" class="form-control col-lg-12" placeholder="play.cwoare.nl" required>
                                </div>
                                <div class="form-group">
                                    <select class="custom-select" id="type">
                                        <option value="">Select resolve type</option>
                                        <option value="SRV">SRV Resolver</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <button id="start" type="button" class="col-lg-12 btn btn-success">Resolve target</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="alert alert-danger" id="output">No output to be shown</div>
                            </div>
                        </div>
                    </div>
                </div><!--end row-->
